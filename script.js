var foss4gMap = {
  ...
  features: [
    ...
    //   description: '<p>Georabble!</p>',
    //   website: 'https://www.theclydehotel.com.au/',
    //   directionsLink: 'https://www.google.com/maps/dir//The+Clyde+Hotel,+385+Cardigan+St,+Carlton+VIC+3053/',
    //   coords: [144.9659, -37.7971],
    //   mobileZoomCoords: [144.9659, -37.7971],
    //   bearing: 0,
    //   zoom: 17,
    //   pitch: 0,
    //   icon: 'beer',
  ...
  getSvgIconUrl: function(iconName, color) {
    ...
    var iconSvg = {
      ...
      cafe: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" height="21" width="21"><title>cafe-15.svg</title><rect fill="none" x="0" y="0" width="21" height="21"></rect><path fill="rgba(255,255,255,0.25)" transform="translate(3 3)" d="M12,5h-2V3H2v4c0.0133,2.2091,1.8149,3.9891,4.024,3.9758C7.4345,10.9673,8.7362,10.2166,9.45,9H12c1.1046,0,2-0.8954,2-2S13.1046,5,12,5z M12,8H9.86C9.9487,7.6739,9.9958,7.3379,10,7V6h2c0.5523,0,1,0.4477,1,1S12.5523,8,12,8z M10,12.5c0,0.2761-0.2239,0.5-0.5,0.5h-7C2.2239,13,2,12.7761,2,12.5S2.2239,12,2.5,12h7C9.7761,12,10,12.2239,10,12.5z" style="stroke-linejoin:round;stroke-miterlimit:4px;" stroke="rgba(255,255,255,0.25)" stroke-width="2"></path><path fill="' + color + '" transform="translate(3 3)" d="M12,5h-2V3H2v4c0.0133,2.2091,1.8149,3.9891,4.024,3.9758C7.4345,10.9673,8.7362,10.2166,9.45,9H12c1.1046,0,2-0.8954,2-2S13.1046,5,12,5z M12,8H9.86C9.9487,7.6739,9.9958,7.3379,10,7V6h2c0.5523,0,1,0.4477,1,1S12.5523,8,12,8z M10,12.5c0,0.2761-0.2239,0.5-0.5,0.5h-7C2.2239,13,2,12.7761,2,12.5S2.2239,12,2.5,12h7C9.7761,12,10,12.2239,10,12.5z"></path></svg>',
